#ifndef _ASIOHPN_MESSAGE_H_
#define _ASIOHPN_MESSAGE_H_
...
public:
  ...
  virtual std::pair<void *, size_t> next_tx_body_buf() = 0;
};
...
public:
  ...
  virtual std::pair<void *, size_t> next_tx_body_buf() {
...
public:
  ...
  virtual ~msg_protobuf_tx_with_body() {
    if (body_) {
